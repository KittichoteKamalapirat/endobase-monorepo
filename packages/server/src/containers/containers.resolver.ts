...
export class ContainersResolver {
  ...
  @Mutation(() => Container)
  createContainer(@Args('createContainerInput') createContainerInput: CreateContainerInput) {
  ...
  @Mutation(() => Container)
  updateContainer(@Args('updateContainerInput') updateContainerInput: UpdateContainerInput) {
    return this.containersService.update(updateContainerInput.id, updateContainerInput);
  }
