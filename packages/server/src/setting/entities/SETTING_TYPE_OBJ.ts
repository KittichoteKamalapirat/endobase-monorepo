...
export type SETTING_TYPE_LABELS = typeof SETTING_TYPE_OBJ[SETTING_TYPE_VALUES]
...
export const settingTypeOptions: SettingLocationOptionType[] = Object.keys(SETTING_TYPE_OBJ).map(key => ({
